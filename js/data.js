...
const products = [
...

  {
    ...
    unitMode: "count",
    unitLabel: "bâton",
    image: "images/Baton de manioc.png",
  ...
  },
  {
    ...
    unitMode: "weight",
    unitLabel: "kg",
    image: "images/Christophine blanche.png",
    description: "Christophine blanche, aussi appelée chayote, est facile à intégrer dans des gratins ou accompagnements.",
    origin: "Afrique de l'Ouest.",
  ...
  },
  {
    ...
    unitMode: "count",
    unitLabel: "piece",
    image: "images/Tapioca sachet.png",
    description: "Tapioca en sachet, idéale pour préparer des plats traditionnels.",
    origin: "Afrique de l'Ouest.",
    storage: "À conserver dans un endroit sec, frais et à l'abri de la lumière.",
    availability: "Disponible selon le stock du jour.",
    orderNote: "Produit vendu au sachet.",
  ...
  {
    id: "Tapioca bouteille",
    name: "Tapioca bouteille",
    category: "Épicerie",
    priceValue: 12,
    unitMode: "count",
    unitLabel: "piece",
    image: "images/Tapioca bouteille.png",
    description: "Tapioca en bouteille, idéale pour préparer des plats traditionnels.",
    origin: "Afrique de l'Ouest.",
    storage: "À conserver dans un endroit sec, frais et à l'abri de la lumière.",
    availability: "Disponible selon le stock du jour.",
    orderNote: "Produit vendu au sachet.",
  ...
  {
    id: "Feuille de patate",
    name: "Feuille de patate",
    category: "Épicerie",
    priceValue: 6.5,
    unitMode: "weight",
    unitLabel: "kg",
    image: "images/Feuille de patate.png",
    description: "Feuille de patate, idéale pour préparer des plats traditionnels.",
    origin: "Afrique de l'Ouest.",
    storage: "À conserver dans un endroit sec, frais et à l'abri de la lumière.",
    availability: "Disponible selon le stock du jour.",
    orderNote: "Produit vendu au sachet.",
  ...
  },
  {
    ...
    description: "Arachide, idéale pour préparer des plats traditionnels.",
    origin: "Afrique de l'Ouest.",
    storage: "À conserver dans un endroit sec, frais et à l'abri de la lumière.",
    availability: "Disponible selon le stock du jour.",
    orderNote: "Produit vendu au sachet.",
